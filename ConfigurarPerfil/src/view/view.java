...
public class view {
	...
	protected static String comandoInstala = "cmd /c start cmd.exe /c \" rundll32 printui.dll PrintUIEntry /in /n \\\\srv_print\\"; // Comando para instalacao da impressora de rede.
